...
conda-dev: ## conda update development dependencies
	conda env update -n mcbac-env -f environment-dev.yaml
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source mcbac -m pytest
	coverage report -m
	coverage html
